	...
	public void getAdapterReady() {		
	    ...
	    gridview.setOnItemClickListener(new OnItemClickListener() {
	        public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
	            ...
	            String imgUploader = imageUploader.get(position);
				...
				dialogPegman.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
				        ...
				        mapBundleDetails.putDouble("gps_lat", Double.parseDouble(imgLat));
				        mapBundleDetails.putDouble("gps_lon", Double.parseDouble(imgLon));
